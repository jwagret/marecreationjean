...
class Adresses
{
    ...
    {
        return 'Type : '.$this->getAdresseType().'<br/>'.
               'N° : '.$this->getAdresseNumero().'<br/>'.
               'Rue : '.$this->getAdresseRue().'<br/>'.
               'Code Postale : '.$this->getAdresseCodepostale().'<br/>'.
               'Ville : '.$this->getAdresseVille().'<br/>'.
               'Pays : '.$this->getAdressePays();
    }
