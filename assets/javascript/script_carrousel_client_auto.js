...
let btnClasse = document.getElementsByClassName("bouton_client");
...
let automatique = () => {
    ...
    //Tableaux
    let slides_classe = document.getElementsByClassName("photo_client");
    ...
    dots_classe[slide_Index-1].style.backgroundColor = getComputedStyle( slides_classe[slide_Index-1],null).backgroundColor;
