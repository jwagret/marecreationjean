 ...
 */
final class Version20220422102102 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE stocks ADD limite_stock INT NOT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE reductions CHANGE reduction_reference reduction_reference VARCHAR(10) NOT NULL COLLATE `utf8mb4_unicode_ci`, CHANGE reduction_designation reduction_designation LONGTEXT NOT NULL COLLATE `utf8mb4_unicode_ci`, CHANGE annee_reductions annee_reductions VARCHAR(255) NOT NULL COLLATE `utf8mb4_unicode_ci`');
        ...
        $this->addSql('ALTER TABLE stocks DROP limite_stock, CHANGE stock_reference stock_reference VARCHAR(255) NOT NULL COLLATE `utf8mb4_unicode_ci`, CHANGE stock_designation stock_designation LONGTEXT NOT NULL COLLATE `utf8mb4_unicode_ci`');
